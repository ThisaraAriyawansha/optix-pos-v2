                ...
                <table class="w-full text-sm font-sans">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-[#1c3350]">
                        @foreach ($customers as $customer)
                            <tr onclick="window.location='{{ route('customers.edit', $customer) }}'"
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <form action="{{ route('customers.toggleStatus', $customer) }}" method="POST" onclick="event.stopPropagation()">
                                        @csrf
                                        @method('PATCH')
                                ...
                                <td class="px-4 py-3 text-right whitespace-nowrap">
                                    <a href="{{ route('customers.edit', $customer) }}" onclick="event.stopPropagation()"
