...
<section class="px-5 pt-6 max-w-6xl mx-auto">
    ...
    <nav class="flex items-center gap-1.5 text-xs font-sans text-gray-400 dark:text-gray-500">
        ...
        <span class="text-gray-700 dark:text-gray-300">Edit User Role</span>
    </nav>

    <h1 class="font-heading font-semibold text-gray-900 dark:text-white text-xl tracking-tight mt-3">Edit User Role</h1>
</section>
